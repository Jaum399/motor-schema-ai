...
export const engineCatalog: EngineRecord[] = [
  ...
  },
  {
    ...
    years: "1960-1990",
    application: "Mercedes 1113, 1313 e linha diesel clássica",
    summary:
      "Motor clássico com regulagem de válvulas a frio, método de balanço em cruz e leitura rápida para oficina.",
    torqueSpecs: [
      { component: "Admissão", sequence: "Motor frio", value: "0,20 mm" },
      { component: "Escape", sequence: "Motor frio", value: "0,30 mm" },
      { component: "Ordem de regulagem", sequence: "Balanço em cruz", value: "1 - 5 - 3 - 6 - 2 - 4" },
      { component: "Medição", sequence: "Lâmina calibradora", value: "Passagem com leve resistência" },
    ],
    notes: [
      "Regular sempre com motor frio e tampa aberta para leitura limpa dos balancins.",
      "Conferir o cilindro em balanço antes de ajustar o correspondente.",
      "Executar duas voltas manuais após a regulagem final.",
    ],
    checklist: [
      "Colocar o cilindro 6 em balanço e regular o 1",
      "Seguir a ordem 1 - 5 - 3 - 6 - 2 - 4",
      "Ajustar admissão em 0,20 mm e escape em 0,30 mm",
      "Revisar reaperto da tampa e teste a frio",
    ],
    tags: ["mercedes", "om352", "1113", "352", "valvulas", "regulagem", "motor frio"],
  },
  {
    id: "mercedes-g211-16",
    brand: "Mercedes-Benz",
